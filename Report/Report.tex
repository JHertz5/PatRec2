...
For normalised data, the trend is decreasing. For raw data, on the other hand, the trend varies, with its local minimum at around 68 bins. 
...
\bf kNN &\bf L1 &\bf L2 &\bf Cos &\bf Corr \\ [0.5ex]
\hline
